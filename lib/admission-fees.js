...
export const COURSES = {
  ...
  // The Yoga Retreat was discontinued. Its batch table is reused for the
  // Sadhana Immersion Programme, which took its slot in the picker.
  "Sadhana Immersion": { label: "Sadhana Immersion Programme", short: "Sadhana Immersion", table: "yoga_retreats" },
};
...
export const ADDONS = {
  ...
  "Sadhana Immersion": {
    key: "Sadhana Immersion", label: "Sadhana Immersion Programme", feeKey: "sadhana", days: 14,
    blurb: "A 14-day immersion for a deeper personal sadhana, running 1st to 14th and 15th to 28th.",
  },
};
