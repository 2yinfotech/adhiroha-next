...
export const COURSE_DAYS = {
  ...
  sound_healing: 6, sadhana: 14, hatha: 14, ashtanga: 14, pranayama: 14,
};

// The courses bookable online, in display order. Hatha, Ashtanga, Pranayama and
// the Sadhana Immersion Programme are arranged with the school directly, so they
// are priced below but deliberately not offered in the picker. Their pages open
// an enquiry form instead (components/CourseEnquiryModal).
...
export const SPECIAL_COURSES = ["Hatha", "Ashtanga", "Pranayama", "Sadhana Immersion"];
...
// difference is shown as a scholarship.
export const ADDONS = {
  "Sound Healing": {
...
export const FEES = {
  ...
  // Sadhana Immersion Programme. Not bookable online; kept so the published
  // fee lives in one place, the same way Hatha/Ashtanga/Pranayama do.
  sadhana: {
...
export function inclusions(course) {
  ...
  if (course === "Sound Healing" || course === "Sadhana Immersion") return base;
