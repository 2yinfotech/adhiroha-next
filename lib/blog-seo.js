...
import { DEFAULT_OG_IMAGE } from "@/lib/root-metadata";
...
export function postMetadata(article, { image } = {}) {
  ...
  // A post with no cover image used to ship no og:image at all, so it shared as
  // a bare link. The school's default share image is better than none.
