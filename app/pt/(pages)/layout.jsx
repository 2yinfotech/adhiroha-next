// Portuguese inner pages share the main site stylesheet + chrome, exactly like the
// English `(main)` route group. The Portuguese homepage ships its own self-contained
// styles (../_home), so it stays at app/pt/page.jsx, outside this route group.
