...
const pageSchema = graph(
  courseSchema({ name: "200-Stunden Yogalehrer-Ausbildung in Rishikesh, Indien", description: metadata.description, url: DE, price: 1275, days: 24, styles: "Hatha, Ashtanga Vinyasa und Yin Yoga" , ...courseFacts("/200-hour-yoga-teacher-training-course-rishikesh/")}),
  courseSchema({ name: "300-Stunden Yogalehrer-Ausbildung in Rishikesh, Indien", description: metadata.description, url: DE, price: 1500, days: 30, styles: "Fortgeschrittene Asana, Pranayama, Philosophie" , ...courseFacts("/300-hour-yoga-teacher-training-course-rishikesh/")}),
  courseSchema({ name: "500-Stunden Yogalehrer-Ausbildung in Rishikesh, Indien", description: metadata.description, url: DE, price: 2790, days: 60, styles: "Hatha, Ashtanga Vinyasa, fortgeschrittene Asana" , ...courseFacts("/500-hour-yoga-teacher-training-course-rishikesh/")}),
