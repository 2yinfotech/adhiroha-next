...
const pageSchema = graph(
  ...studentVideoSchemas(),
  courseSchema({ name: "Formación de Profesor de Hatha y Yin Yoga en Rishikesh", description: metadata.description, url: ES, price: 790, days: 14, styles: "Hatha Yoga, Yin Yoga, Alignment, Pranayama, Meditation" , ...courseFacts("/hatha-teacher-training-course-rishikesh/")}),
