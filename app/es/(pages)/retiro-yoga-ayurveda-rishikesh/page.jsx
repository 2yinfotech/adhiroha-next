...
const pageSchema = graph(
  courseSchema({ name: "Retiro de Bienestar Yoga & Ayurveda en Rishikesh", description: metadata.description, url: ES, price: 510, days: 6, styles: "Hatha Yoga, terapias ayurvédicas, meditación, bienestar" }),
