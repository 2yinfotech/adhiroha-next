...
const pageSchema = graph(
  courseSchema({ name: "Formazione Insegnanti in Guarigione del Suono e Terapia a Rishikesh", description: metadata.description, url: IT, price: 690, days: 6, styles: "Ciotole tibetane, gong, canto dei mantra, sonoterapia" , ...courseFacts("/sound-healing-ttc-rishikesh/")}),
