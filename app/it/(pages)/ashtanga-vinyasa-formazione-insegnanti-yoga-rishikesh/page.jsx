...
const pageSchema = graph(
  ...studentVideoSchemas(),
  courseSchema({ name: "Formazione Insegnanti di Yoga Ashtanga & Vinyasa a Rishikesh", description: metadata.description, url: IT, price: 790, days: 14, styles: "Serie primaria Ashtanga, sequenze vinyasa, pranayama, meditazione" , ...courseFacts("/ashtanga-teacher-training-course-rishikesh/")}),
