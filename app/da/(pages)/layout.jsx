// Danish inner pages share the main site stylesheet + chrome, exactly like the
// English `(main)` route group. The Danish homepage ships its own self-contained
// styles (../_home), so it stays at app/da/page.jsx, outside this route group.
...
export default function DanishPagesLayout({ children }) {
  return (
    <>
      {children}
      <StickyHeader />
