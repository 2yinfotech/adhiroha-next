// Dutch inner pages share the main site stylesheet + chrome, exactly like the
// English `(main)` route group. The Dutch homepage ships its own self-contained
// styles (../_home), so it stays at app/nl/page.jsx, outside this route group.
...
export default function DutchPagesLayout({ children }) {
  return (
    <>
      {children}
      <StickyHeader />
